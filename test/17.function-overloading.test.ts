...
it("testing...", () => {
  ...
  function perkalian(a: number): number;
...
// Deklarasi overload: menerima number → number
...
// Deklarasi overload: 1 parameter
function sapa(nama: string): string;

// Deklarasi overload: 2 parameter
function sapa(namaDepan: string, namaBelakang: string): string;

// Implementasi
function sapa(a: string, b?: string): string {
  if (b) {
    return `Halo ${a} ${b}`;
  }
  return `Halo ${a}`;
...
// ===================================================================
// * CONTOH: OVERLOAD DENGAN ARRAY ATAU SATU ITEM
// ===================================================================

// Overload menerima string
function cetakPesan(pesan: string): void;

// Overload menerima array of string
function cetakPesan(pesan: string[]): void;
