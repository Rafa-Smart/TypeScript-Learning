...
test("testing...", () => {
  ...
  console.log((nama as string).length);
  // atau
  let panjang = (nama as string).length;
  console.log(panjang);
...
// ===================================================================
let nilaiAneh = "text" as unknown as number;
...
let userSalah = {} as User; // ❗ Tidak error, padahal belum ada `id`, `nama`

// Solusi yang lebih aman: inisialisasi langsung
let userAman: User = { id: 2, nama: "Dafi" };
