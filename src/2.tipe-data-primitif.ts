...
let pesan: string = `Halo, ${nama}` // menggunakan template literal
...
let sama: boolean = (id1 === id2) // false → karena symbol selalu unik

// 7. bigint (ES2020+)
// Digunakan untuk menyimpan angka sangat besar (melebihi batas Number.MAX_SAFE_INTEGER).
// Ditulis dengan akhiran 'n'.

let angkaBesar: bigint = 9007199254740991n
let hasilBesar: bigint = angkaBesar + 1n
...
// Contoh:
let mungkinKosong: string | null = null
let mungkinBelum: string | undefined = undefined
