describe("testing", () => {
  ...
  it("testing...", () => {
    ...
    let user1:Orang = new Orang('rafa', 15);
    ...
    // coba lagi 
    function test(objek:Orang){
        return objek.sayHello('rafa');
    }

    // jadi kita menggunakan tipedata Orang disetiap elemen pada arranya
    const data:Orang[] = [new Orang('rafa',15),new Guru('jamal',15),new Dosen('udin',15)]
  ...
  // Penjelasan:
  // Walaupun variabel bertipe Animal, method yang dipanggil adalah milik class aslinya (Dog, Cat, Animal).
  // Inilah bentuk paling nyata dari polymorphism: satu interface (Animal), banyak bentuk (Dog, Cat, Animal).

  // ===================== MENGGUNAKAN POLYMORPHISM DENGAN INTERFACE =====================
