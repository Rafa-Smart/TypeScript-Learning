...
let sample:Function | string | boolean = 'rafa';
...
let arr2: (string | number | boolean)[] = [1, "dua", 3, "empat", true, false];
arr2.forEach((el) => {
  if (typeof el === "string") {
...
function cetakNilai(n: string | number) {
  if (typeof n === "string") {
...
let arr: (string | number)[] = [1, "dua", 3, "empat"];
arr.forEach((el) => {
  if (typeof el === "string") {
    console.log("String:", el.toUpperCase());
  } else {
...
// ===================================================================
// any     → tipe bebas, tidak ada keamanan tipe
// unknown → tipe bebas tapi aman, harus dicek dulu
// union   → membatasi hanya pada tipe tertentu yang didefinisikan

// let a: any = "bebas";
// let b: unknown = 123;
// let c: string | number = "halo";

// a.toUpperCase();        // ✅ Tidak error, tapi bisa crash
// b.toUpperCase();        // ❌ Harus dicek
// c.toUpperCase();        // ❌ Harus dicek (karena bisa jadi number)

// if (typeof c === "string") {
//   console.log(c.toUpperCase()); // ✅ Aman
// }

// ===================================================================
// * KEUNTUNGAN UNION TYPE
// ===================================================================
// ✅ Lebih aman dari `any`, karena hanya tipe yang ditentukan yang diizinkan
// ✅ Memberikan fleksibilitas, namun tetap menjaga validasi tipe
// ✅ Cocok untuk fungsi dengan input bervariasi
// ✅ Sangat berguna saat menangani data dinamis seperti dari JSON/API

// ===================================================================
// * KEKURANGAN UNION TYPE
// ===================================================================
// ❌ Harus melakukan pemeriksaan tipe secara manual (typeof, instanceof)
// ❌ Tidak bisa langsung mengakses properti atau method dari semua tipe
// ❌ Bisa membuat logika kompleks jika union terlalu banyak tipe

// ===================================================================
// * ADVANCED: UNION DENGAN TYPE GUARDS & DISCRIMINATED UNION
// ===================================================================
type Kucing = {
  jenis: "kucing",
  meong: () => void
